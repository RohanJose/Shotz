    ...
    <footer className="bg-black text-white pt-24 pb-12 relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full overflow-hidden leading-none">
        <svg
          ...
          className="w-full h-[60px] fill-shotz-yellow transform rotate-180"
        >
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start mb-16">
          <div className="max-w-md">
            <h2 className="font-display text-8xl text-transparent text-stroke-white mb-6">
              SHOTZ
            </h2>
          ...
          <div className="flex flex-col items-start">
            <div className="flex flex-wrap gap-4 mt-8 md:mt-0">
              {[
                { icon: Instagram, label: "", href: "https://www.instagram.com/drinkshotz/" },
                { icon: Mail, label: "", href: "mailto:drinkshotztea@gmail.com" },
                { icon: Youtube, label: "", href: "#" }
              ].map((social, i) => (
                <a
                  key={i}
                  href={social.href}
                  className="flex items-center gap-2 bg-gray-900 px-6 py-3 rounded-xl font-display text-xl
                             hover:bg-shotz-lime hover:text-black hover:rotate-3 transition-all"
                >
            ...
            <p className="text-sm text-gray-400 mt-4">
              Marketed by <br /><span className="font-semibold">HOUSE OF SHOTZ</span>,<br />Thodupuzha, Idukki, Kerala
            </p>

            {/* Mail Below */}
            <p className="text-sm text-gray-400 mt-1">
             
              <a href="mailto:drinkshotztea@gmail.com " className="underline">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 border-t border-gray-800 pt-12">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 font-medium cursor-pointer">
              <li>
                <a href="#flavors" className="hover:text-white text-left block">
                  All Flavors
                </a>
              </li>
              <li>
                <button onClick={onShopClick} className="hover:text-white text-left">
                  Merch
                </button>
              </li>
            </ul>
            ...
            <form className="flex gap-2">
              <input
                ...
                className="flex-1 bg-gray-900 border border-gray-700 rounded-lg px-4 py-3
                           focus:outline-none focus:border-shotz-lime text-white font-bold"
              />
              <button className="bg-white text-black px-6 py-3 rounded-lg font-bold hover:bg-shotz-lime transition-colors">
                SUBMIT
              </button>
            </form>
          </div>
        ...
        <div className="mt-20 pt-8 border-t border-gray-900 flex justify-between items-center text-gray-500 text-sm font-bold">
          ...
          <button
            ...
            className="bg-gray-800 p-3 rounded-full hover:bg-shotz-lime hover:text-black transition-colors"
          >
            <ArrowUp />
          </button>
        </div>
